...
const MQTT_CLIENT_ID: &str = "trailer-fridge-publisher";
const FREQUENCY_MS: &str = "frequency_ms";

#[derive(Debug, Serialize, Deserialize)]
struct TrailerTempProperty {
    #[serde(rename = "TrailerTemp")]
    trailer_temp: trailer_v1::trailer::trailer_temperature::TYPE,
...
#[derive(Debug)]
pub struct TrailerFridgePropertiesProviderImpl {
    pub data_stream: watch::Receiver<i32>,
    pub min_interval_ms: u64,
    entity_map: Arc<RwLock<HashMap<String, Vec<TopicInfo>>>>,
}

/// Create the JSON for the trailer temp property.
///
/// # Arguments
/// * `trailer_temp` - The trailer temp value.
fn create_property_json(trailer_temp: i32) -> String {
    let metadata = Metadata {
        model: trailer_v1::trailer::trailer_temperature::ID.to_string(),
    };

    let property: TrailerTempProperty = TrailerTempProperty {
        trailer_temp,
        metadata,
    };
...
impl TrailerFridgePropertiesProviderImpl {
    ...
    pub fn new(data_stream: watch::Receiver<i32>, min_interval_ms: u64) -> Self {
        ...
        entity_map.insert(
            trailer_v1::trailer::trailer_temperature::ID.to_string(),
            Vec::new(),
        );

        // Create new instance.
        TrailerFridgePropertiesProviderImpl {
            data_stream,
            min_interval_ms,
        ...
        tokio::spawn(async move {
            ...
            loop {
                ...
                info!(
                    ...
                    trailer_v1::trailer::trailer_temperature::NAME
                );
...
#[tonic::async_trait]
impl ManagedSubscribeCallback for TrailerFridgePropertiesProviderImpl {
